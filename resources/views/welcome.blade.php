...
<!-- Mirrored from crenoveative.com/envato/togoby/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Aug 2017 05:51:49 GMT -->
<head>
                                ...
                                <div class="GridLex-col-4_mdd-4_sm-6_xs-6_xss-12">
                                    ...
                                    <div class="trip-guide-item">
                                        ...
                                        <div class="trip-guide-image">
                                            <img src="images/ภูวิว.jpg" alt="images" />
                                        </div>
                                            ...
                                            <div class="row gap-10">
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="trip-guide-price">
                                                        Starting at
                                                        <span class="block inline-block-xs">{{$item->amount}} BATH</span>
                                                    </div>
                                                </div>
                                                <form action="{{route('checksomething')}}" method="POST">
...
<div id="loginModal" class="modal fade login-box-wrapper" tabindex="-1" data-width="550" data-backdrop="static" data-keyboard="false" data-replace="true">
    ...
    <div class="modal-footer text-center">
        <button type="subbmit" class="btn btn-primary">Log-in</button>
        ...
        <div class="row gap-20">
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"> 
                    <label>Name</label>
                    <input class="form-control" placeholder="Min 4 and Max 10 characters" type="text" id="name" name="name"value="{{ old('name') }}" required autofocus> 
                    @if ($errors->has('name'))
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}"> 
                    ...
                    <input id="email" class="form-control" placeholder="Enter your email address" name="email" type="text" value="{{ old('email') }}" required autofocus> 
                    @if ($errors->has('name'))
                                    <span class="help-block">
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}"> 
                    ...
                    <input class="form-control" placeholder="Min 8 and Max 20 characters" type="text" name="password"> 
                </div>
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="form-group"> 
                    ...
                    <input class="form-control" placeholder="Re-type password again" type="text" name="password_confirmation"> 
                </div>
...
<!-- Mirrored from crenoveative.com/envato/togoby/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Aug 2017 05:52:27 GMT -->
</html>